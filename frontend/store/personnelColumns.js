...
export const personnelColumns = [
  ...
  { key: "department", label: "Departman", type: "select", dynamic: true },
  ...
  { key: "marital_status", label: "Medeni Durum", type: "select", options:["EVLİ", "BEKAR", "DUL"] },
  ...
  { key: "criminal_record", label: "Adli Sicil", type: "select",  options:["VAR", "YOK"]  },
